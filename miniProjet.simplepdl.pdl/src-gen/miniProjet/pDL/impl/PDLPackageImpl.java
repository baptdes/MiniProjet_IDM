...
public class PDLPackageImpl extends EPackageImpl implements PDLPackage
{
   ...
   * @see miniProjet.pDL.PDLPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(processEClass, miniProjet.pDL.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1, miniProjet.pDL.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProcess_ProcessElements(), this.getProcessElement(), null, "processElements", null, 0, -1, miniProjet.pDL.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getNeed_Used(), this.getBOOLEAN(), "used", null, 0, 1, Need.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    // Initialize enums and add enum literals
    initEEnum(booleanEEnum, miniProjet.pDL.BOOLEAN.class, "BOOLEAN");
    addEEnumLiteral(booleanEEnum, miniProjet.pDL.BOOLEAN.TRUE);
    addEEnumLiteral(booleanEEnum, miniProjet.pDL.BOOLEAN.FALSE);
