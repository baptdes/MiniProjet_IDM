 ...
 * </p>
 * <ul>
 *   <li>{@link simplepdl.impl.RessourceImpl#getNeed <em>Need</em>}</li>
...
public class RessourceImpl extends ProcessElementImpl implements Ressource {
	...
	public EList<Need> getNeed() {
		if (need == null) {
			need = new EObjectResolvingEList<Need>(Need.class, this, SimplepdlPackage.RESSOURCE__NEED);
		}
		return need;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimplepdlPackage.RESSOURCE__NEED:
				return getNeed();
