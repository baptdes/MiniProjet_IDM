...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RESSOURCE__NEED = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Ressource#getNeed <em>Need</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Need</em>'.
	 * @see simplepdl.Ressource#getNeed()
	 * @see #getRessource()
	 * @generated
	 */
	EReference getRessource_Need();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference RESSOURCE__NEED = eINSTANCE.getRessource_Need();
