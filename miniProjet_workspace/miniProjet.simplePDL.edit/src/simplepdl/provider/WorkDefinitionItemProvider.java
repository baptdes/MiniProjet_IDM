	...
	protected void addNeedsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkDefinition_needs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_needs_feature", "_UI_WorkDefinition_type"),
				 SimplepdlPackage.Literals.WORK_DEFINITION__NEEDS,
				 true,
				 false,
				 true,
				 null,
