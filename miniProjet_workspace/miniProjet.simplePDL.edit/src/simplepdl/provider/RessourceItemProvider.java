		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_needs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_needs_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__NEEDS,
				 true,
				 false,
				 true,
				 null,
