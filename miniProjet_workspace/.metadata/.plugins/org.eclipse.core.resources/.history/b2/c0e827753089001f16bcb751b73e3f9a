...
public class ProcessImpl extends MinimalEObjectImpl.Container implements simplepdl.Process {
	...
	public EList<ProcessElement> getProcesselement() {
		if (processelement == null) {
			processelement = new EObjectContainmentWithInverseEList<ProcessElement>(ProcessElement.class, this, SimplepdlPackage.PROCESS__PROCESSELEMENT, SimplepdlPackage.PROCESS_ELEMENT__PROCESS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimplepdlPackage.PROCESS__PROCESSELEMENT:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getProcesselement()).basicAdd(otherEnd, msgs);
		}
