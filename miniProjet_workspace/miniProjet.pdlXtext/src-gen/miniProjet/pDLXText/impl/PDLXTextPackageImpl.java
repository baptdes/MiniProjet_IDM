 ...
 * @generated
 */
public class PDLXTextPackageImpl extends EPackageImpl implements PDLXTextPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see miniProjet.pDLXText.PDLXTextPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private PDLXTextPackageImpl()
  {
    super(eNS_URI, PDLXTextFactory.eINSTANCE);
  }
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *
   * <p>This method is used to initialize {@link PDLXTextPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static PDLXTextPackage init()
  {
    if (isInited) return (PDLXTextPackage)EPackage.Registry.INSTANCE.getEPackage(PDLXTextPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredPDLXTextPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    PDLXTextPackageImpl thePDLXTextPackage = registeredPDLXTextPackage instanceof PDLXTextPackageImpl ? (PDLXTextPackageImpl)registeredPDLXTextPackage : new PDLXTextPackageImpl();

    isInited = true;

    // Create package meta-data objects
    thePDLXTextPackage.createPackageContents();

    // Initialize created meta-data
    thePDLXTextPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    thePDLXTextPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(PDLXTextPackage.eNS_URI, thePDLXTextPackage);
    return thePDLXTextPackage;
  }
   ...
   */
  @Override
  public PDLXTextFactory getPDLXTextFactory()
  {
    return (PDLXTextFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(processEClass, miniProjet.pDLXText.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1, miniProjet.pDLXText.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProcess_ProcessElements(), this.getProcessElement(), null, "processElements", null, 0, -1, miniProjet.pDLXText.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
