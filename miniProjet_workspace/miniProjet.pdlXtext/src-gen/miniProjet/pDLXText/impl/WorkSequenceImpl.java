 ...
 * </p>
 * <ul>
 *   <li>{@link miniProjet.pDLXText.impl.WorkSequenceImpl#getLinkType <em>Link Type</em>}</li>
 *   <li>{@link miniProjet.pDLXText.impl.WorkSequenceImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link miniProjet.pDLXText.impl.WorkSequenceImpl#getSuccessor <em>Successor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkSequenceImpl extends ProcessElementImpl implements WorkSequence
{
  ...
  {
    return PDLXTextPackage.Literals.WORK_SEQUENCE;
  }
  ...
  public void setLinkType(WorkSequenceType newLinkType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLXTextPackage.WORK_SEQUENCE__LINK_TYPE, oldLinkType, linkType));
  }
  ...
  public WorkDefinition getPredecessor()
  {
    if (predecessor != null && predecessor.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDLXTextPackage.WORK_SEQUENCE__PREDECESSOR, oldPredecessor, predecessor));
      }
    }
    return predecessor;
  }
  ...
  public void setPredecessor(WorkDefinition newPredecessor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLXTextPackage.WORK_SEQUENCE__PREDECESSOR, oldPredecessor, predecessor));
  }
  ...
  public WorkDefinition getSuccessor()
  {
    if (successor != null && successor.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDLXTextPackage.WORK_SEQUENCE__SUCCESSOR, oldSuccessor, successor));
      }
    }
    return successor;
  }
  ...
  public void setSuccessor(WorkDefinition newSuccessor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLXTextPackage.WORK_SEQUENCE__SUCCESSOR, oldSuccessor, successor));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDLXTextPackage.WORK_SEQUENCE__LINK_TYPE:
        return getLinkType();
      case PDLXTextPackage.WORK_SEQUENCE__PREDECESSOR:
        if (resolve) return getPredecessor();
        return basicGetPredecessor();
      case PDLXTextPackage.WORK_SEQUENCE__SUCCESSOR:
