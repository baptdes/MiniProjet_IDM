 ...
 * @generated
 */
public class PDLXTextSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        miniProjet.pDLXText.Process process = (miniProjet.pDLXText.Process)theEObject;
        T result = caseProcess(process);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case PDLXTextPackage.PROCESS_ELEMENT:
      {
   ...
   * @generated
   */
  public T caseProcess(miniProjet.pDLXText.Process object)
  {
    return null;
  }
