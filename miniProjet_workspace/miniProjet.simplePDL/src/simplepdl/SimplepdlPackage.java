...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__LINKS_TO_SUCCESSORS = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__NEEDS = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int NEED__PROCESS = PROCESS_ELEMENT__PROCESS;
	 ...
	 * @ordered
	 */
	int NEED__QUANTITY_NEEDED = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int NEED__USED = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int NEED_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int RESSOURCE__NEEDS = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE__NAME = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.WorkDefinition#getNeeds <em>Needs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link simplepdl.Need#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressource</em>'.
	 * @see simplepdl.Need#getRessource()
	 * @see #getNeed()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Need#getQuantityNeeded <em>Quantity Needed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantity Needed</em>'.
	 * @see simplepdl.Need#getQuantityNeeded()
	 * @see #getNeed()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Need#isUsed <em>Used</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Used</em>'.
	 * @see simplepdl.Need#isUsed()
	 * @see #getNeed()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Ressource#getNeeds <em>Needs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Needs</em>'.
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference RESSOURCE__NEEDS = eINSTANCE.getRessource_Needs();
